...
class Template
{
	 ...
	 * @return	array
	 */
	private function load_views($view, $data = array())
	{
	...
	function single($content, $data = array()){
	  	echo $this->load_views($content.'.php', $data, TRUE);
	}

	// public function single($content, $data) {
